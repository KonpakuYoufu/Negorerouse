...
public class Nier {
    ...
    public void postInit(LoadEvent.PostInitEvent event){
        ...
        IRecipe recipe;
        if (Loader.isModLoaded("lastsmith")) {
            recipe = new RecipeAwakeBladeTLS(new ResourceLocation(NegoreRouse.MODID,"nier"),
                    "bewitched_blade", blackblade,materialBlade,
                    new Object[]{
                            "SA ",
                            "ABA",
                            " ZX",
            ...
            recipe = new NrRecipeBlade(new ResourceLocation(NegoreRouse.MODID,"nier"),
