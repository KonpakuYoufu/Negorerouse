...
public class Protogenoi {
    ...
    public void postInit(LoadEvent.PostInitEvent event){
        ...
        IRecipe recipe;
        if (Loader.isModLoaded("lastsmith")) {
            recipe = new RecipeAwakeBladeTLS(new ResourceLocation(NegoreRouse.MODID,"protogenoi"),
                    "final_blade", blackblade,materialBlade,
                    new Object[]{
                            " A ",
                            " S ",
                            " A ",
            ...
            recipe = new NrRecipeBlade(new ResourceLocation(NegoreRouse.MODID,"protogenoi"),
