...
public class ChronosN {
    ...
    public void postInit(LoadEvent.PostInitEvent event){
        ...
        if (Loader.isModLoaded("lastsmith")) {
            recipe = new RecipeAwakeBladeTLS(new ResourceLocation(NegoreRouse.MODID,"chronosn"),
            ...
            recipe = new NrRecipeBlade(new ResourceLocation(NegoreRouse.MODID,"chronosn"),
