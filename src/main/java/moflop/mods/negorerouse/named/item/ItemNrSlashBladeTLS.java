 ...
 */
public class ItemNrSlashBladeTLS extends ItemSlashBladeNamedTLS {
    public ItemNrSlashBladeTLS(ToolMaterial par2EnumToolMaterial, float baseAttackModifiers,String name) {
