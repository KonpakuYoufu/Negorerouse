...
public class Hercules {
    ...
    public void postInit(LoadEvent.PostInitEvent event){
        ...
        IRecipe recipe;
        if (Loader.isModLoaded("lastsmith")) {
            recipe = new RecipeAwakeBladeTLS(new ResourceLocation(NegoreRouse.MODID,"hercules"),
                    "sharpness", blackblade,materialBlade,
                    new Object[]{
                            " AS",
                            "ABA",
                            "ZA ",
            ...
            recipe = new NrRecipeBlade(new ResourceLocation(NegoreRouse.MODID,"hercules"),
