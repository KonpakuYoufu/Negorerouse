...
public class Chronos {
    ...
    public void postInit(LoadEvent.PostInitEvent event){
        ...
        IRecipe recipe;
        if (Loader.isModLoaded("lastsmith")) {
            recipe = new RecipeAwakeBladeTLS(new ResourceLocation(NegoreRouse.MODID,"chronos"),
                "sharpness", blackblade,materialBladeA,
                    new Object[]{
                            "ZX ",
                            "SBD",
                            " XH",
            ...
            recipe = new NrRecipeBlade(new ResourceLocation(NegoreRouse.MODID,"chronos"),
